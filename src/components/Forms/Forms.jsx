...
const Forms = () => {
    const { handleSubmit, categoryData, title, content, imageUrl, userEmail, likeCount, viewCount, userCommentCount, category, dispatch, isLoading, setLoading } = useContext(DataContext);
